...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-09 15:15`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ffe50987-89b1-4cf0-8b57-96a7e4d98bd6.git
$ cd ffe50987-89b1-4cf0-8b57-96a7e4d98bd6
```
